  ...
  return (
    <AppLayout>
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="pb-6 border-b-2 border-border-strong border-dashed mb-8">
          ...
          <div className="text-base lg:text-lg text-text-secondary leading-relaxed font-medium">
            <span className="bg-primary px-1.5 py-0.5 text-fixed-black font-bold border-2 border-border-strong rounded-sm text-sm">1. Upload</span> source PDFs. <span className="bg-primary px-1.5 py-0.5 text-fixed-black font-bold border-2 border-border-strong rounded-sm text-sm">2. Add</span> .tex template. <span className="bg-primary px-1.5 py-0.5 text-fixed-black font-bold border-2 border-border-strong rounded-sm text-sm">3. Define</span> subjects.
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <div className="xl:col-span-2 space-y-8">
            {/* Source Files */}
            <div className="bg-surface-light p-6 border-2 border-border-strong shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded-md">
...
4. Methodology Simplification"
          ...
          <div className="xl:col-span-1">
            <div className="bg-surface-light p-6 border-2 border-border-strong shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex flex-col gap-6 sticky top-6 rounded-md">
              ...
              <div className="p-4 bg-primary-light border-2 border-border-strong flex justify-between items-center rounded-md">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="bg-fixed-black text-fixed-white font-mono font-bold text-sm px-2 py-1 rounded-sm">
              ...
              <div className="space-y-2">
                ...
                <input
                  className="w-full px-3 py-3 bg-fixed-white border-2 border-border-strong rounded-md text-sm text-text-main placeholder:text-text-muted font-medium focus:outline-none focus:border-primary-hover focus:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all"
