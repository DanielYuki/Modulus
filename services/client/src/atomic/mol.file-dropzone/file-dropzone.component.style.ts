...
export const fileDropzoneStyle = tv({
  slots: {
    ...
    dropzone: [
      ...
      'border-2 border-dashed border-border-strong rounded-md',
      'bg-background',
    ...
    title: 'text-lg font-bold text-text-main bg-fixed-white px-2 inline-block rounded-sm',
    subtitle: 'text-xs text-text-secondary font-mono uppercase bg-gray-100 px-2 py-1 rounded-sm',
